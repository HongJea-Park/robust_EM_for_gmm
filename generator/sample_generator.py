...
class generator_multivariate_normal():
    ...
    '''
        Class for generating n-dimensions sample data set with multivariate normal distribution.
    ...
    def get_sample(self, size):
        ...
        for n in range(0, self.n_components_):
            ...
            X_n= np.random.multivariate_normal(mean= mean, cov= cov, size= num_of_sample)
...
class generator_univariate_normal():
    ...
    '''
        Class for generating one-dimension sample data set with univariate normal distribution.
